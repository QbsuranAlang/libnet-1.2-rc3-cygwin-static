...
/* ./.libs/lt-icmp6_echoreq.c - temporary wrapper executable for .libs/icmp6_echoreq
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The icmp6_echoreq program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "icmp6_echoreq"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# icmp6_echoreq - temporary wrapper script for .libs/icmp6_echoreq\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The icmp6_echoreq program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"icmp6_echoreq:icmp6_echoreq:${LINENO}: libtool wrapper (GNU libtool) ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"icmp6_echoreq:icmp6_echoreq:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"icmp6_echoreq:icmp6_echoreq:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
