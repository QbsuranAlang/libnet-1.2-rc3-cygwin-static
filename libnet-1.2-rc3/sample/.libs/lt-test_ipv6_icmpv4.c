...
/* ./.libs/lt-test_ipv6_icmpv4.c - temporary wrapper executable for .libs/test_ipv6_icmpv4
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The test_ipv6_icmpv4 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_ipv6_icmpv4"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_ipv6_icmpv4 - temporary wrapper script for .libs/test_ipv6_icmpv4\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The test_ipv6_icmpv4 program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"test_ipv6_icmpv4:test_ipv6_icmpv4:${LINENO}: libtool wrapper (GNU lib", f);
  fputs ("tool) 2.4.2 Debian-2.4.2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_ipv6_icmpv4:test_ipv6_icmpv4:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_ipv6_icmpv4:test_ipv6_icmpv4:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_ipv6_icmpv4'\n", f);
