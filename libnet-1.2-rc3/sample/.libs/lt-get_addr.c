...
/* ./.libs/lt-get_addr.c - temporary wrapper executable for .libs/get_addr
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The get_addr program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "get_addr"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# get_addr - temporary wrapper script for .libs/get_addr\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The get_addr program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"get_addr:get_addr:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debi", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"get_addr:get_addr:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"get_addr:get_addr:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
