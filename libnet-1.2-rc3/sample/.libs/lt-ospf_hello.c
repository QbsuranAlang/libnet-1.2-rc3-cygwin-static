...
/* ./.libs/lt-ospf_hello.c - temporary wrapper executable for .libs/ospf_hello
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The ospf_hello program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ospf_hello"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ospf_hello - temporary wrapper script for .libs/ospf_hello\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The ospf_hello program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ospf_hello:ospf_hello:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ospf_hello:ospf_hello:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ospf_hello:ospf_hello:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
