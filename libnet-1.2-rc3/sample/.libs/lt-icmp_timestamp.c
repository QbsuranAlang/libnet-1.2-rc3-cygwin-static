...
/* ./.libs/lt-icmp_timestamp.c - temporary wrapper executable for .libs/icmp_timestamp
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The icmp_timestamp program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "icmp_timestamp"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# icmp_timestamp - temporary wrapper script for .libs/icmp_timestamp\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The icmp_timestamp program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"icmp_timestamp:icmp_timestamp:${LINENO}: libtool wrapper (GNU libtool", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"icmp_timestamp:icmp_timestamp:${LINENO}: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"icmp_timestamp:icmp_timestamp:${LINENO}: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
