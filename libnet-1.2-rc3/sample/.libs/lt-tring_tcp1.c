...
/* ./.libs/lt-tring_tcp1.c - temporary wrapper executable for .libs/tring_tcp1
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The tring_tcp1 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "tring_tcp1"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tring_tcp1 - temporary wrapper script for .libs/tring_tcp1\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The tring_tcp1 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"tring_tcp1:tring_tcp1:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 ", f);
  fputs ("Debian-2.4.2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"tring_tcp1:tring_tcp1:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"tring_tcp1:tring_tcp1:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
