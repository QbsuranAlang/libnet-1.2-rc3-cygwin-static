...
/* ./.libs/lt-ip_raw.c - temporary wrapper executable for .libs/ip_raw
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The ip_raw program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ip_raw"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ip_raw - temporary wrapper script for .libs/ip_raw\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The ip_raw program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ip_raw:ip_raw:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2", f);
  fputs (".4.2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ip_raw:ip_raw:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ip_raw:ip_raw:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
