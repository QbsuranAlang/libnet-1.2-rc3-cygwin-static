...
/* ./.libs/lt-smurf.c - temporary wrapper executable for .libs/smurf
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The smurf program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "smurf"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# smurf - temporary wrapper script for .libs/smurf\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The smurf program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"smurf:smurf:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2.4", f);
  fputs (".2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"smurf:smurf:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"smurf:smurf:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
