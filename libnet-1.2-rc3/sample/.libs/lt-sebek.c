...
/* ./.libs/lt-sebek.c - temporary wrapper executable for .libs/sebek
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The sebek program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "sebek"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sebek - temporary wrapper script for .libs/sebek\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The sebek program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"sebek:sebek:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2.4", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sebek:sebek:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sebek:sebek:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
