...
/* ./.libs/lt-mpls.c - temporary wrapper executable for .libs/mpls
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The mpls program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "mpls"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# mpls - temporary wrapper script for .libs/mpls\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The mpls program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"mpls:mpls:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"mpls:mpls:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"mpls:mpls:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
