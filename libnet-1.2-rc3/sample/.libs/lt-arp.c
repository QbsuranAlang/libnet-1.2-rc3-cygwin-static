...
/* ./.libs/lt-arp.c - temporary wrapper executable for .libs/arp
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The arp program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "arp"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# arp - temporary wrapper script for .libs/arp\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The arp program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"arp:arp:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1", f);
  fputs (".2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"arp:arp:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"arp:arp:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
