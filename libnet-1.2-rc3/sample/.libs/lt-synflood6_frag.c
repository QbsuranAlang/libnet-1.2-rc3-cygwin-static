...
/* ./.libs/lt-synflood6_frag.c - temporary wrapper executable for .libs/synflood6_frag
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The synflood6_frag program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "synflood6_frag"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# synflood6_frag - temporary wrapper script for .libs/synflood6_frag\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The synflood6_frag program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"synflood6_frag:synflood6_frag:${LINENO}: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.2 Debian-2.4.2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"synflood6_frag:synflood6_frag:${LINENO}: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"synflood6_frag:synflood6_frag:${LINENO}: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
