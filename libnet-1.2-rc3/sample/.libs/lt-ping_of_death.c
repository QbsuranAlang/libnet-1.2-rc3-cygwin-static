...
/* ./.libs/lt-ping_of_death.c - temporary wrapper executable for .libs/ping_of_death
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The ping_of_death program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ping_of_death"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ping_of_death - temporary wrapper script for .libs/ping_of_death\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The ping_of_death program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ping_of_death:ping_of_death:${LINENO}: libtool wrapper (GNU libtool) ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ping_of_death:ping_of_death:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ping_of_death:ping_of_death:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
