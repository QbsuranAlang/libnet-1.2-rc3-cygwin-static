...
/* ./.libs/lt-ospf_lsa.c - temporary wrapper executable for .libs/ospf_lsa
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The ospf_lsa program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ospf_lsa"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ospf_lsa - temporary wrapper script for .libs/ospf_lsa\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The ospf_lsa program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ospf_lsa:ospf_lsa:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debi", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ospf_lsa:ospf_lsa:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ospf_lsa:ospf_lsa:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
