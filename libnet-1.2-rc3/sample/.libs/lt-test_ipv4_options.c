...
/* ./.libs/lt-test_ipv4_options.c - temporary wrapper executable for .libs/test_ipv4_options
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The test_ipv4_options program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_ipv4_options"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_ipv4_options - temporary wrapper script for .libs/test_ipv4_options\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The test_ipv4_options program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"test_ipv4_options:test_ipv4_options:${LINENO}: libtool wrapper (GNU l", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_ipv4_options:test_ipv4_options:${LINENO}: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_ipv4_options:test_ipv4_options:${LINENO}: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_ipv4_options'\n", f);
