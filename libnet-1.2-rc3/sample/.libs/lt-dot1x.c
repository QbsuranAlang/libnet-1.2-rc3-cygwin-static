...
/* ./.libs/lt-dot1x.c - temporary wrapper executable for .libs/dot1x
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The dot1x program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dot1x"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# dot1x - temporary wrapper script for .libs/dot1x\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The dot1x program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"dot1x:dot1x:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian-2.4", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dot1x:dot1x:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dot1x:dot1x:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
