...
/* ./.libs/lt-icmp_timeexceed.c - temporary wrapper executable for .libs/icmp_timeexceed
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The icmp_timeexceed program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "icmp_timeexceed"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# icmp_timeexceed - temporary wrapper script for .libs/icmp_timeexceed\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The icmp_timeexceed program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"icmp_timeexceed:icmp_timeexceed:${LINENO}: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.2 Debian-2.4.2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"icmp_timeexceed:icmp_timeexceed:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"icmp_timeexceed:icmp_timeexceed:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
