...
/* ./.libs/lt-icmp_unreach.c - temporary wrapper executable for .libs/icmp_unreach
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The icmp_unreach program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "icmp_unreach"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# icmp_unreach - temporary wrapper script for .libs/icmp_unreach\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The icmp_unreach program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"icmp_unreach:icmp_unreach:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"icmp_unreach:icmp_unreach:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"icmp_unreach:icmp_unreach:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
