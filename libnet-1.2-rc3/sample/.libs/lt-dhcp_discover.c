...
/* ./.libs/lt-dhcp_discover.c - temporary wrapper executable for .libs/dhcp_discover
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The dhcp_discover program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dhcp_discover"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# dhcp_discover - temporary wrapper script for .libs/dhcp_discover\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The dhcp_discover program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"dhcp_discover:dhcp_discover:${LINENO}: libtool wrapper (GNU libtool) ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dhcp_discover:dhcp_discover:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dhcp_discover:dhcp_discover:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
