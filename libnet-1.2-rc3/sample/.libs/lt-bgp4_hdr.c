...
/* ./.libs/lt-bgp4_hdr.c - temporary wrapper executable for .libs/bgp4_hdr
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The bgp4_hdr program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "bgp4_hdr"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bgp4_hdr - temporary wrapper script for .libs/bgp4_hdr\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The bgp4_hdr program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"bgp4_hdr:bgp4_hdr:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debi", f);
  fputs ("an-2.4.2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bgp4_hdr:bgp4_hdr:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bgp4_hdr:bgp4_hdr:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
