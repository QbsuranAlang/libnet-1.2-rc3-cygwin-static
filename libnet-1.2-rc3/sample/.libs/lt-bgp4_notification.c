...
/* ./.libs/lt-bgp4_notification.c - temporary wrapper executable for .libs/bgp4_notification
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The bgp4_notification program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "bgp4_notification"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bgp4_notification - temporary wrapper script for .libs/bgp4_notification\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The bgp4_notification program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"bgp4_notification:bgp4_notification:${LINENO}: libtool wrapper (GNU l", f);
  fputs ("ibtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bgp4_notification:bgp4_notification:${LINENO}: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bgp4_notification:bgp4_notification:${LINENO}: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='bgp4_notification'\n", f);
