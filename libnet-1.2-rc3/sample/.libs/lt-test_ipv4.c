...
/* ./.libs/lt-test_ipv4.c - temporary wrapper executable for .libs/test_ipv4
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The test_ipv4 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_ipv4"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_ipv4 - temporary wrapper script for .libs/test_ipv4\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The test_ipv4 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test_ipv4:test_ipv4:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 De", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_ipv4:test_ipv4:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_ipv4:test_ipv4:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
