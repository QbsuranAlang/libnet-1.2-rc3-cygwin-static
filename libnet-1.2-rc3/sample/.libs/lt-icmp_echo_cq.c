...
/* ./.libs/lt-icmp_echo_cq.c - temporary wrapper executable for .libs/icmp_echo_cq
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The icmp_echo_cq program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "icmp_echo_cq"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# icmp_echo_cq - temporary wrapper script for .libs/icmp_echo_cq\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The icmp_echo_cq program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"icmp_echo_cq:icmp_echo_cq:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.2 Debian-2.4.2-1.2ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"icmp_echo_cq:icmp_echo_cq:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"icmp_echo_cq:icmp_echo_cq:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
