...
/* ./.libs/lt-rpc_udp.c - temporary wrapper executable for .libs/rpc_udp
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1

   The rpc_udp program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "rpc_udp"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# rpc_udp - temporary wrapper script for .libs/rpc_udp\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.2ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The rpc_udp program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"rpc_udp:rpc_udp:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"rpc_udp:rpc_udp:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"rpc_udp:rpc_udp:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
